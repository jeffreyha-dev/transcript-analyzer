/**
 * Database Migration Script - Phase 6.1
 * Adds api_endpoint_path to liveperson_accounts table
 */
...
function runMigration() {
    return new Promise((resolve, reject) => {
        db.serialize(() => {
            console.log('Starting migration (Phase 6.1)...');
            ...
            db.all("PRAGMA table_info(liveperson_accounts)", (err, columns) => {
                ...
                if (!columnNames.includes('api_endpoint_path')) {
                    columnsToAdd.push("ALTER TABLE liveperson_accounts ADD COLUMN api_endpoint_path TEXT DEFAULT '/messaging_history/api/account/{accountId}/conversations/search'");
                }
